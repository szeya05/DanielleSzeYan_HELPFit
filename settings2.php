    ...
    <br/>
        ...
        <br/>
  		<label> Specialty: </label>
  		 <input type="text" id="specialty" name="specialty" style="color:black;"  value="<?php echo $_SESSION['trainer']['specialty'];?>"/><br/>
  		</br></br></br>
  		<div>
  		<button type="submit" class="selectBtn" style="padding:11px 20px;" name="submit">Save changes</button>
  		<div class="divider"/>
  		<a href="welcomeTrainer.php"><input type="button" name="Cancel" class="selectBtn" style="padding:11px 20px;" value="Cancel"></a>
  		</div>
      <br/><br/>
  		</form>
      </div>

...
<div class="container-fluid">
  <div class="row">
    ...
    <button type="submit" id = "buttonStyle"><a href = "viewTrainingHistory.html">View Training History</a></button>
  </div>
  <div class = "col-xs-12 col-sm-12" id = "center2">
   <button type="submit" id = "buttonStyle"><a href = "registerTraining.html">Register for Training Session</a></button>
   </div>
 </div>
  </div>
</div>

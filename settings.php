      ...
      <div class = "container">
        <div class = "row">
          <div class = "col-sm-4 col-md-2 col-lg-2">
            <a href="welcomeMember.html"><img src = "HELPFitLogo.jpg" alt = "HELPFitLogo" display = "inline-block"></a>
          </div>
          <div class="col-sm-5 col-md-5 col-lg-3">
            <input type="text" id="search" placeholder="Search.."></input>
            <button id="searchbtn">Go</button>
          </div>
          <div class = "col-sm-2 col-md-1 col-lg-1 col-md-offset-2">
...
<div class="container-fluid" id="bg">
  <div class="row" id="box">
    ...
    <form action="#" method = "post" id="form" name="form">
        ...
        <input type="text" id="oldpassword" name="newpassword" style="color:black;"/><br/>
      <br/>
    ...
    <div name="level" id="level">
      <label class="radio">
        <input type = "radio" name="level" value="beginner" <?php if ($_SESSION['user']['level'] == "beginner"){ print "checked";} ?>>
        <div class="choice">Beginner</div>
      </label>
      <label class="radio">
        <input type = "radio" name="level" value="intermediate" <?php if ($_SESSION['user']['level'] == "intermediate"){ print "checked";} ?>>
        <div class="choice">Intermediate</div>
      </label>
      <label class="radio">
        <input type = "radio" name="level" value="expert" <?php if ($_SESSION['user']['level'] == "expert"){ print "checked";} ?>>

...
<head>
  ...
  <title>Update Personal Training Session</title>
...
<div class = "image"><br/>
<?php echo '<form action = "updatePR.php?session_ID=' .$session_ID.'" method = "post">';?>
  <div class = "container" style="background-color:#dfdee5;">
    <div class = "row">
      <h2 style = "text-align:center;">Update Personal Training Session</h2><br/>
    </div>
  ...
  <div class="row">
    <div class="form-group">
        <label class="col-xs-12 col-sm-3 col-sm-offset-1">Notes:</label>
        <div class="col-xs-12 col-sm-7">
            <input type = "text" name = "notes" class="form-control" id="comment">
        </div>
    </div>
  </div>
  </br>
